...
const changelog = [
  {
    ...
    changes: [
      "26.2 미리보기 화면의 글자를 브라우저에서 더 매끄럽게 표시해요.",
      "26.2 미리보기의 세로 화면 안내와 Eaglercraft·게임 문구를 한국어로 바꿨어요.",
      "저장된 60·120 FPS 제한을 풀고 화면 주사율에 맞춰 그리도록 바꿨어요. 실제 FPS는 화면과 브라우저, 기기 성능에 따라 달라져요.",
      "화면 품질을 유지하면서 같은 GPU 설정을 반복해서 보내는 작업을 줄였어요. FO 전체 모드 이식은 아직 진행 중이에요.",
      "채팅을 머리 아이콘, 굵은 이름, 내용 순서로 표시해요. 이름에는 갈무리11 볼드를 쓰고 꺾쇠는 없앴어요.",
      "가까운 곳에 거칠게 보이던 간이 원거리 지형을 없앴어요. 서버 렌더 거리는 늘리지 않아요.",
      "채팅 머리가 포탈 스킨의 얼굴과 모자를 사용해요.",
  ...
  },
  {
    ...
    changes: [
      ...
      "설정 드롭다운의 오른쪽 여백을 조금 넓혔어요.",
      "토글 손잡이 위치를 가운데에 맞추고 그림자와 눌림 확대 효과를 없앴어요.",
      "되돌리기와 설정 저장 버튼을 설정 패널 오른쪽 아래에 고정했어요.",
      "서버 설정 하단에 남던 구분선 두 개를 없앴어요.",
      "서버 설정 항목 사이의 줄을 없애고 게임 모드 선택창을 입력창 크기에 맞췄어요.",
