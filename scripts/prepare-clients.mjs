...
const sourceName = "stable-source.html";
...
const outputPath = path.join(root, "public/game", "stable.html");
...
console.log(`stable: ${output.length.toLocaleString()} chars, split EPW ${epwFileName}, streaming WASM ${wasmFileName}, loading screens and bridge injected with Brotli and gzip variants`);
